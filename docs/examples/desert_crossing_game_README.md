...
1. **时间单位**: 以天为单位，从第0天开始，截止日期为第30天
2. **目标**: 在截止日期前到达终点，保留尽可能多的资金
3. **资源**: 水和食物（最小单位：箱）
4. **约束**: 每天携带的水和食物总重量不能超过负重上限 (1200 kg)
5. **初始资金**: ¥10,000

### 天气系统 (Weather System)

天气影响资源消耗率。每天的天气状况事先已知：

- **晴朗**: 水消耗 5箱/天，食物消耗 7箱/天
- **高温**: 水消耗 8箱/天，食物消耗 6箱/天  
- **沙暴**: 水消耗 10箱/天，食物消耗 10箱/天，且必须停留原地不能移动
...
- **初始资金**: ¥10,000
- **水**: 每箱重量 3 kg，基准价格 ¥5/箱，村庄价格 ¥10/箱
- **食物**: 每箱重量 2 kg，基准价格 ¥10/箱，村庄价格 ¥20/箱
- **挖矿收益**: ¥1,000/天（基础收益）
- **退回价格**: 基准价格 × 50%

### 资源消耗表 (Resource Consumption Table)
...
*注：以上为停留时的基础消耗量，移动时消耗 ×2，挖矿时消耗 ×3*
